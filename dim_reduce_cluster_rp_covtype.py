...
rp = random_projection.GaussianRandomProjection(n_components = 54)
...
reconstruction_error_rp_covtype = np.concatenate((np.arange(1,55).reshape(-1,1), reconstruction_error), axis = 1)
