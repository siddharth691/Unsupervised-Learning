...
fig, ax = plt.subplots()
ax.bar(list(range(1,55)), pca.explained_variance_ratio_, linewidth=2, color = 'blue')
plt.axis('tight')
...
reconstruction_error_pca_covtype = np.concatenate((np.arange(1,55).reshape(-1,1), reconstruction_error), axis = 1)
